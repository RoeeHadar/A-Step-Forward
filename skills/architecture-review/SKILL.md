...
4. `skills/architecture-review/REFERENCE.md` — checklists and anti-patterns
...
Use `skills/architecture-review/templates/architecture-assessment.md`.
...
- **Prefer Neon-direct** for free-tier critical path unless Python-only logic requires Render (`skills/neon-direct-route/SKILL.md`).

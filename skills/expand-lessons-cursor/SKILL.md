...
description: Substantive bilingual lesson expansion using Cursor Composer 2.5 locally — NOT Groq CI batch jobs. Read BEFORE bulk-rewriting scripts/seed_data/lessons/ for depth, Hebrew parity, or question explanations. Pair with skills/author-lesson/SKILL.md and skills/expand-lesson-theory/SKILL.md.
---
...
#    Read skills/author-lesson + this file. Edit scripts/seed_data/lessons/<id>.json
...
> Read `skills/expand-lessons-cursor/SKILL.md` and expand

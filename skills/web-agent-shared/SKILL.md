...
- `skills/agent-skill-notes/SKILL.md` — note schema and top-K read contract
- `skills/learner-persona/SKILL.md` — shared persona rules
- `skills/dreaming-and-consolidation/SKILL.md` — full dreaming pipeline

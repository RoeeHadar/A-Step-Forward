---
concept_id: "integrals_applications"
name: "Integral Applications (Volumes & Optimization)"
name_he: "יישומי אינטגרלים (נפחים ובעיות קיצון)"
subject: math
level: high_school
...
prerequisites: ["integrals_techniques", "optimization_problems"]
tags:
  - concept/math
  - status/done
  - completeness/full
...
# Integral Applications (Volumes & Optimization)

**HE:** יישומי אינטגרלים (נפחים ובעיות קיצון)
...
[[concepts/integrals_techniques|integrals_techniques]], [[concepts/optimization_problems|optimization_problems]]
...
- **5pt:** Less frequent but possible Bagrut topic; volumes tested occasionally
...
- [[concepts/uni_applications_integrals|uni_applications_integrals]]

## Links

- Lesson JSON: `scripts/seed_data/lessons/integrals_applications.json`

...
export const SUBJECT_LABELS: Record<string, { en: string; he: string; icon: string }> = {
  ...
  math_3: { en: 'High School Math — 3pt', he: 'מתמטיקה — 3 יח״ל', icon: '3' },
  'math-3': { en: 'High School Math — 3pt', he: 'מתמטיקה — 3 יח״ל', icon: '3' },
  math_4: { en: 'High School Math — 4pt', he: 'מתמטיקה — 4 יח״ל', icon: '4' },
  'math-4': { en: 'High School Math — 4pt', he: 'מתמטיקה — 4 יח״ל', icon: '4' },
  math_5: { en: 'High School Math — 5pt', he: 'מתמטיקה — 5 יח״ל', icon: '5' },
  'math-5': { en: 'High School Math — 5pt', he: 'מתמטיקה — 5 יח״ל', icon: '5' },

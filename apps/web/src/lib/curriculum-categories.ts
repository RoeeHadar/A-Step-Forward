    ...
    sections: [
      {
        ...
        concept_ids: [
          'descriptive_statistics', 'basic_probability', 'normal_distribution_basics', 'scatter_plot_correlation_intro',
          'basic_statistics_3pt', 'probability_basics_3pt', 'probability_conditional_3pt',
          'descriptive_stats', 'statistics_descriptive', 'probability_basic',
        ],
      },
      {
        id: 'geometry_3pt',
        ...
        concept_ids: [
          'pythagorean_theorem', 'circle_area_circumference', 'similar_triangles', '3d_solids_volume', 'spatial_reasoning',
          'geometry_basics', 'analytic_geometry_basic',
        ],
      },
      {
        id: 'functions_3pt',
        ...
        concept_ids: [
          'linear_equations_one_variable', 'linear_functions', 'quadratic_model_fitting', 'exponential_growth_decay_models',
          'algebra_basics', 'arithmetic', 'equations_linear', 'equations_quadratic', 'exponents', 'factoring',
          'fractions_algebraic', 'inequalities', 'word_problems',
          'functions_intro', 'functions_linear', 'functions_quadratic', 'functions_exponential',
          'sequences_arithmetic', 'sequences_geometric',
        ],
      },
      {
        ...
        concept_ids: ['plane_trigonometry_right_triangle', 'trigonometry_ratios'],
      },
      {
        id: 'applied_3pt',
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      },
      {
        ...
        concept_ids: [
          'analytic_geometry', 'analytic_geometry_lines_circles', 'trigonometry_plane_sine_cosine_law',
          'circles', 'quadrilaterals', 'triangles_congruence',
        ],
      },
      {
        id: 'statistics_4pt',
        ...
        enLabel: 'Statistics & Probability',
        concept_ids: [
          'descriptive_statistics', 'normal_distribution_z_scores', 'linear_regression_correlation',
          'hypothesis_testing_intro', 'combinatorics',
        ],
      },
      {
        id: 'sequences_4pt',
    ...
    sections: [
      {
        ...
        concept_ids: [
          ...
          'function_analysis_asymptotes', 'integrals_trigonometric', 'integrals_substitution_basic',
          'volumes_of_revolution', 'derivatives_exponential_logarithm',
          'limits', 'continuity', 'derivatives_rules', 'derivatives_applications',
          'integrals_intro', 'definite_integrals', 'integrals_techniques', 'integrals_applications',
      ...
      },
      {
        ...
        concept_ids: [
          'sequences_arithmetic', 'sequences_geometric', 'mathematical_induction', 'binomial_distribution_bernoulli',
          'function_transformations', 'logarithms',
        ],
      },
      {
        id: 'trigonometry_5pt',
      ...
      },
      {
        ...
        concept_ids: ['vectors_dot_product_3d', 'complex_numbers_de_moivre', 'vectors_2d', 'complex_numbers'],
      },
      {
        id: 'probability_5pt',
        heLabel: 'הסתברות',
        enLabel: 'Probability & Combinatorics',
        concept_ids: ['probability_conditional_bayes', 'binomial_distribution_bernoulli', 'distributions'],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        enLabel: 'Mechanics',
        concept_ids: [
          'kinematics_1d', 'projectile_motion', 'newton_laws', 'work_energy_conservation',
          'momentum_impulse_collisions', 'circular_motion_gravitation',
          'units_measurement', 'vectors_basics', 'kinematics_2d', 'friction', 'circular_motion',
          'gravitation', 'work_energy', 'conservation_energy', 'momentum', 'collisions',
          'simple_harmonic_motion', 'torque', 'static_equilibrium',
          'rotational_kinematics', 'rotational_dynamics', 'angular_momentum',
        ],
      },
      {
        id: 'electricity_hs',
        ...
        concept_ids: [
          'coulomb_law', 'electric_field_potential', 'dc_circuits_kirchhoff',
          'capacitors_parallel_plate', 'magnetic_force', 'faraday_induction',
          'electrostatics', 'electric_field', 'electric_potential', 'electric_circuits',
          'kirchhoff_laws', 'magnetism', 'electromagnetic_induction', 'ac_circuits',
        ],
      },
      {
        id: 'waves_optics_hs',
        ...
        concept_ids: [
          'geometric_optics_refraction', 'em_waves',
          'waves_basics', 'sound_waves', 'doppler',
          'optics_geometric', 'optics_physical',
        ],
      },
      {
        ...
        concept_ids: [
          ...
          'modern_physics_intro', 'atomic_models', 'nuclear_physics', 'special_relativity',
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        concept_ids: ['limits_intro', 'continuity_uniform', 'limits_epsilon_delta', 'limits', 'continuity'],
      },
      {
        ...
        concept_ids: [
          'derivatives_intro', 'derivatives_chain_rule', 'derivatives_implicit', 'mean_value_theorem',
          'derivatives_rules', 'derivatives_applications',
        ],
      },
      {
        id: 'series_taylor',
    ...
    sections: [
      {
        ...
        concept_ids: [
          'integrals_intro', 'integration_substitution', 'integration_by_parts',
          'integration_partial_fractions', 'riemann_integral_ftc', 'improper_integrals',
          'definite_integrals', 'integrals_techniques', 'integrals_applications',
        ],
      },
      {
        id: 'series_calc2',
    ...
    sections: [
      {
        ...
        concept_ids: [
          'probability_basic', 'probability_conditional_bayes', 'discrete_distributions_binomial_poisson',
          'combinatorics', 'statistics_descriptive', 'descriptive_stats', 'distributions',
        ],
      },
      {

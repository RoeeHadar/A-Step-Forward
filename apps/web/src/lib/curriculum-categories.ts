...
const MATH_4PT_NEW_CONCEPTS = [
  // Foundations (visible parent path when browsing 4pt learn)
  'algebra_basics',
  'equations_linear',
  'equations_quadratic',
  'functions_intro',
...
const MATH_5PT_NEW_CONCEPTS = [
  // Foundations (visible when browsing 5pt learn)
  'algebra_basics',
  'equations_linear',
  'equations_quadratic',
  'functions_intro',
  ...
  'limits_5pt',
  'limits_at_infinity',
  'limits_trigonometric_5pt',
  'derivatives_intro',
  'derivatives_chain_rule',
  'derivatives_trigonometric',
  'derivatives_trig_exp',
  // implicit_differentiation: university / explanatory only — not MoE 5pt catalog
  ...
  'circles',
  // Euclidean geometry (questionnaire geometry craft; not only analytic)
  'triangles_congruence',
  'similar_triangles',
  'quadrilaterals',
...
const MATH_5PT_KG_LEGACY = [
  ...
  'vectors_2d',
  'distributions',
  // bare `limits` removed — use limits_5pt (algebraic MoE), not squeeze/ε–δ variant
  'continuity',
  'derivatives_intro',
  'derivatives_rules',
  'derivatives_applications',
...
export const CURRICULUM_CATEGORIES: CurriculumCategory[] = [
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    sections: [
      {
        id: 'foundations_4pt',
        heLabel: 'יסודות — אלגברה ופונקציות',
        enLabel: 'Foundations — Algebra & Functions',
        exam_paper: 'paper_1',
        concept_ids: [
          'algebra_basics',
          'equations_linear',
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      {
        id: 'paper2_euclidean_geometry_5pt',
        heLabel: 'שאלון 2 — גאומטריה אוקלידית',
        enLabel: 'Paper 2 — Euclidean Geometry',
        exam_paper: 'paper_2',
        concept_ids: [
          'triangles_congruence',
          'similar_triangles',
      ...
      },
      {
        ...
        heLabel: 'שאלון 2 — גאומטריה אנליטית (פרבולה ואליפסה)',
        enLabel: 'Paper 2 — Analytic Geometry (Parabola & Ellipse)',
        exam_paper: 'paper_2',
        concept_ids: [
          'analytic_geometry',
          'analytic_geometry_5pt',
  ...
  // ──────────────────────────────────────────────────────────────────────────
  // CALCULUS 1 — University (20406 חדו״א א — real exam level)
  // ──────────────────────────────────────────────────────────────────────────
  {
    id: 'calculus_1',
    heLabel: 'חדו״א 1',
    ...
    sections: [
      {
        ...
        concept_ids: ['number_sets_review', 'function_basics_uni'],
      },
      {
      ...
      {
        id: 'sequences_series_calc1',
        heLabel: 'סדרות וטורים',
        enLabel: 'Sequences & Series',
        concept_ids: [
          'sequences_limits',
          'sequences_monotone_bounded',
          'series_convergence_tests',
      ...
      {
        id: 'integration_techniques_calc1',
        heLabel: 'טכניקות אינטגרציה',
        enLabel: 'Integration Techniques',
        concept_ids: [
          'antiderivatives',
          'integration_substitution',
          'integration_by_parts',
      ...
      {
        id: 'improper_integrals_calc1',
        heLabel: 'אינטגרלים לא אמיתיים',
        enLabel: 'Improper Integrals',
        concept_ids: [
          'improper_integrals',
          'convergence_divergence_integrals',
        ],

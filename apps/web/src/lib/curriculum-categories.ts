...
export const CURRICULUM_CATEGORIES: CurriculumCategory[] = [
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    sections: [
      {
        id: 'sh801-algebra',
        heLabel: 'שאלון 801 — אלגברה',
        enLabel: 'Questionnaire 801 — Algebra',
        concept_ids: ['arithmetic', 'algebra_basics', 'equations_linear', 'equations_quadratic', 'exponents'],
      },
      {
        id: 'sh801-analytic-geo',
        heLabel: 'שאלון 801 — גיאומטריה אנליטית',
        enLabel: 'Questionnaire 801 — Analytic Geometry',
        concept_ids: ['analytic_geometry_basic', 'functions_linear'],
      },
      {
        id: 'sh801-sequences',
        heLabel: 'שאלון 801 — סדרות חשבוניות',
        enLabel: 'Questionnaire 801 — Arithmetic Sequences',
        concept_ids: ['sequences_arithmetic'],
      },
      {
        id: 'sh801-trigonometry',
        heLabel: 'שאלון 801 — טריגונומטריה במישור',
        enLabel: 'Questionnaire 801 — Trigonometry (Plane)',
      ...
      },
      {
        ...
        heLabel: 'שאלון 802 — סדרות וגדילה',
        enLabel: 'Questionnaire 802 — Sequences & Discrete Growth',
        concept_ids: ['sequences_arithmetic', 'functions_quadratic'],
      },
      {
        id: 'sh802-trig-3d',
        heLabel: 'שאלון 802 — טריגונומטריה במרחב',
        enLabel: 'Questionnaire 802 — Trigonometry in Space',
      ...
      },
      {
        ...
        heLabel: 'שאלון 803 — בעיות מילוליות ואחוזים',
        enLabel: 'Questionnaire 803 — Word Problems & Percentages',
        concept_ids: ['word_problems', 'arithmetic'],
      },
      {
        id: 'sh803-analytic-geo',
        heLabel: 'שאלון 803 — גיאומטריה אנליטית (מעגל)',
        enLabel: 'Questionnaire 803 — Analytic Geometry (Circle)',
        concept_ids: ['analytic_geometry_basic', 'functions_linear'],
      },
      {
        id: 'sh803-calculus-3pt',
        heLabel: 'שאלון 803 — חשבון דיפרנציאלי ואינטגרלי (3 יח\')',
        enLabel: 'Questionnaire 803 — Differential & Integral Calculus (3 units)',
        concept_ids: ['functions_quadratic', 'functions_intro'],
      },
    ],
  },

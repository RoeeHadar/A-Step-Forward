...
/** Same-tab locale sync between I18nProvider and useLanguagePreference. */
export const LOCALE_CHANGED_EVENT = 'asf-locale-changed';

export function dispatchLocaleChanged(locale: Locale) {

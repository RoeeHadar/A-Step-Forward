...
|--------|----------------|
| [Addy Osmani — code-review-and-quality](https://github.com/addyosmani/agent-skills/blob/HEAD/.cursor/skills/code-review-and-quality/SKILL.md) | Five axes, edge cases, presumptive blockers, test behavior |

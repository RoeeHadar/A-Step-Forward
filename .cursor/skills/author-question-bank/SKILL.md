...
The 10 supported `kind` values, per-kind `answer_payload` shapes, and rendering / grading rules are documented exhaustively in `.cursor/skills/author-lesson/SKILL.md` — read that file before writing new questions.

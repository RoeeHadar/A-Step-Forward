...
|--------------------------|------------|------------------------|
| Frontend | `.cursor/subagent-briefs/01-frontend.md` | `.cursor/skills/add-a-frontend-page/SKILL.md` |
| Backend / API | `.cursor/subagent-briefs/02-backend-api.md` | `.cursor/skills/add-a-backend-endpoint/SKILL.md` |
| Agents | `.cursor/subagent-briefs/03-agents.md` | `.cursor/skills/build-an-agent/SKILL.md`, `.cursor/skills/prompt-authoring/SKILL.md` |
| Memory | `.cursor/subagent-briefs/04-memory.md` | `.cursor/skills/memory-operations/SKILL.md`, `.cursor/skills/dreaming-and-consolidation/SKILL.md` |
| GraphRAG | `.cursor/subagent-briefs/05-graphrag.md` | `.cursor/skills/graphrag-ingestion/SKILL.md` |
| MCP | `.cursor/subagent-briefs/06-mcp-servers.md` | `.cursor/skills/build-an-mcp-server/SKILL.md` |
| Curriculum | `.cursor/subagent-briefs/07-curriculum.md` | `.cursor/skills/seed-curriculum/SKILL.md` |
| Evals | `.cursor/subagent-briefs/08-evals-qa.md` | `.cursor/skills/run-evals/SKILL.md` |
| Infra | `.cursor/subagent-briefs/09-infra.md` | `.cursor/skills/deploy/SKILL.md`, `.cursor/skills/db-migrations/SKILL.md`, `.cursor/skills/pnpm-lockfile-ci/SKILL.md` |
| Security | `.cursor/subagent-briefs/10-security-safety.md` | `.cursor/skills/security-safety/SKILL.md` |
...
- Check for missing DB migrations — remind agent to use `.cursor/skills/db-migrations/SKILL.md`.

...
- `.cursor/skills/onboarding-flow/SKILL.md` — questionnaire → profile fields  
- `.cursor/skills/use-learning-plan/SKILL.md` — planner contract for agents (mid-journey)  
- `.cursor/skills/neon-direct-route/SKILL.md` — Vercel + Neon route patterns  
- `.cursor/skills/deploy/SKILL.md` — post-push verify  

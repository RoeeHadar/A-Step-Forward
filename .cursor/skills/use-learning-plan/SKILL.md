...
`docs/adr/0008-adaptive-wellbeing-planning.md` and `.cursor/skills/web-agent-mentor/SKILL.md`.
...
See `.cursor/skills/cross-subject-kg/SKILL.md` for the full edge-authoring workflow.

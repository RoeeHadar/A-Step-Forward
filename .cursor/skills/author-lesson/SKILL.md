...
**Cursor Composer 2.5** locally — see `.cursor/skills/expand-lessons-cursor/SKILL.md`.
...
- The learning-plan engine reads `skill_practice` to weigh prerequisite urgency. See `.cursor/skills/use-learning-plan/SKILL.md`.

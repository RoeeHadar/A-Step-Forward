...
(see `.cursor/skills/diagnostic-plan-golden-path/SKILL.md` trial-and-error log).
...
have renderable MCQs in `diagnostic_items` (see `.cursor/skills/diagnostic-plan-golden-path/SKILL.md`).
...
`.cursor/skills/diagnostic-plan-golden-path/SKILL.md`. If you need longer plans (e.g.

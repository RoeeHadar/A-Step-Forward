...
| `skills/diagnostic-plan-golden-path/SKILL.md` | Diagnostic session state, post-diagnostic plan persist (`?fast=1`), client poll UX, what worked/failed in onboarding golden path. |
...
| `skills/web-agent-coach/SKILL.md` | Coach runtime skills: drills, FSRS, weak atoms. |
| `skills/web-agent-reviewer/SKILL.md` | Reviewer runtime skills: rubric-first submission feedback. |
